...
// Create the scene
  ...
  // Load a sound and set it as the buffer for the audio object
    ...
    audioLoader.load('assets/realistic-gun-fire-100696.mp3', function (buffer) {
...
// Add lightning
const ambient = new THREE.HemisphereLight(0xffffbb, 0x080820, 10000);
scene.add(ambient);
...
loader.load(assetPath + 'assets/9mm_new1.glb', function(gltf){
